...
export const companyLegalInfo: (t: TranslationFunction, lang: "it" | "en") => JSX.Element = (t, lang) =>(
<>
      <strong>{t('footer.company_info.name')}</strong>{t('footer.company_info.detail_info')}<br />{t('footer.company_info.detail_info_2')}
    </>
);

export const preLoginLinks: (t: TranslationFunction, lang: LangCode, windowURL?: string) => PreLoginFooterLinksType = (
    t, lang, windowURL
  ) => ({
    // First column
    aboutUs: {
    ...
    resources: {
      ...
      links: [
        ...
        },
        {
          ...
          ariaLabel: t('footer.pre_login.resources.information_security.ariaLabel'),
          linkType: "internal",
        },
        {
        ...
        // },
        {
          ...
          ariaLabel: t('footer.pre_login.resources.transparent_company.ariaLabel'),
          linkType: "internal",
        },
        {
...
export const postLoginLinks: (t: TranslationFunction, lang: "it" | "en") => Array<FooterLinksType> = (
    t, lang
  ) => ([
    {
...
export const pagoPALink: (t: TranslationFunction, lang: "it" | "en") => ILinkData = (
  t, lang
) => ({
