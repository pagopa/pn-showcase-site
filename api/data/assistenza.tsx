      ...
      <Grid item xs={12} md={6} sx={{ backgroundColor: "#F5F5F5", padding: 4 }}>
        <Stack alignItems="center" justifyContent="center" spacing={2}>
          ...
          >
            ...
            destinatari-send@assistenza.pagopa.it: includi informazioni utili
            come il codice univoco della notifica (IUN).
          </Typography>
      ...
      <Grid item xs={12} md={6} sx={{ backgroundColor: "#FAFAFA", padding: 4 }}>
        <Stack alignItems="center" justifyContent="center" spacing={2}>
          ...
          >
            ...
            06.4520.2323 per assistenza dedicata dal lunedì al venerdì dalle 08
            alle 20 e il sabato dalle 08.00 alle 14.00.
          </Typography>
          <Button variant="outlined" color="primary">
            Chiamaci
          </Button>
